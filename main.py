"""
AI Resume Optimiser & Generator (Cohere + PDF Export)
-----------------------------------------------------
...
# CONFIGURATION
# ---------------------------
COHERE_API_KEY = "vIRl4pdzxB3hVxpwOefpo1D3rD45p9BLMpdJXWy8"  # Replace
...
def save_as_pdf(text, filename="optimised_resume.pdf"):
    ...
    for line in lines:
        ...
        # Headings: UPPERCASE lines of short length
...
if __name__ == "__main__":
    ...
    # Extract only resume text for saving
    ...
    # Save explanation separately (optional)
    if explanation_text:
